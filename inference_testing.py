...
def load_model(path: str):
    model = DeepNarrowTransformerModel((256, 96, 2), (256, 96, 2), 0.0)
...
if __name__ == "__main__":
    ...
    model = DeepNarrowTransformerModel((256, 96, 2), (256, 96, 2), 0.25)
    state_dict = torch.load("/media/qhawkins/SSD3/single_models/pretrained_ddp_val_loss_000116003_epoch_5_mse_deep_narrow_transformer.pth")
    state_dict = state_dict['model_state_dict']
